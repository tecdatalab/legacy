...
class transformable_pdb : public pdb
{
 public:
  ...
  // Adds the specified magnitude to every atomic coordinate, overwritting
  // the previous values.
  void translate(double x_translation, double y_translation,
  ...
  void apply_point_transformation_sequence(
 ...
 private:
  ...
  void apply_any_point_transformation(point_transformation* transformation,
                                      bool is_inverse);
