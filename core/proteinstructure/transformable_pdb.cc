...
void transformable_pdb::translate(double x_translation, double y_translation,
...
void transformable_pdb::apply_point_transformation(
    point_transformation* transformation) {
  apply_any_point_transformation(transformation, false);
}

void transformable_pdb::apply_inverse_point_transformation(
    point_transformation* transformation) {
  apply_any_point_transformation(transformation, true);
}

void transformable_pdb::apply_any_point_transformation(
    point_transformation* transformation, bool is_inverse) {
...
void transformable_pdb::apply_point_transformation_sequence(
