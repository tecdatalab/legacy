...
date
./extract_xml_information.sh xml/ idlist.txt name.txt fullname.txt contour_levels.txt resolutions.txt resolution_summary.txt

# Generate all 3DZD representations required
echo "Step 4: Generate 3DZDs for new maps..."
date
./calculate_volume_and_3dzd.pl contour_levels.txt map/ volume.txt ./ >& volume_3dzd.log
...
date
./extract_xml_information.sh $PRODUCTIONDIR/xml/ idlist.txt name.txt fullname.txt contour_levels.txt resolutions.txt resolution_summary.txt
...
date
cp idlist.txt name.txt fullname.txt resolutions.txt resolution_summary.txt volume.txt $PRODUCTIONDIR
