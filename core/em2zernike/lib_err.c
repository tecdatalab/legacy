...
void error_memory_allocation(int error_number, char *program) {
...
void error_option(int error_number, char *program) {
...
void error_density(int error_number, char *program) {
...
void error_EOF(int error_number, char *program) {
...
void error_file_convert(int error_number, char *program, char *filename) {
	fprintf(stderr, "%s> Error: Unable to convert all data from file %s [e.c. %d]\n", program, filename, error_number); 
	exit(error_number);
}
void error_file_header(int error_number, char *program, char *filename) {
	fprintf(stderr, "%s> Error: Unable to read header of file %s [e.c. %d]\n", program, filename, error_number); 
	exit(error_number);
}
void error_file_float_mode(int error_number,char *program, char *filename) {
...
void error_axis_assignment(int error_number, char *program) {
...
void error_spider_header(int error_number, char *program) {
...
void error_divide_zero(int error_number, char *program) {
	fprintf(stderr, "%s> Error: dividing by zero [e.c. %d]\n", program, error_number); 
	exit(error_number); 
}
void error_sqrt_negative(int error_number, char *program) {
	fprintf(stderr, "%s> Error: sqrt argument negative [e.c. %d]\n", program, error_number); 
	exit(error_number); 
}
void error_write_filename(int error_number, char *program) {
...
void error_negative_euler(int error_number, char *program) {
...
void error_atom_count(int error_number, char *program, int i, int atom_count) {
	fprintf(stderr, "%s> Error: Inconsistent atom count %d %d [e.c. %d]\n", program, i, atom_count, error_number); 
	exit(error_number);
}
void error_no_bounding(int error_number, char *program, char *shape) {
	fprintf(stderr, "%s> Error: no bounding %s found [e.c. %d]\n", program, shape, error_number); 
	exit(error_number);
}
void error_underflow(int error_number, char *program) {
...
void error_normalize(int error_number, char *program) {
	fprintf(stderr, "%s> Error: Normalization by zero [e.c. %d]\n", program, error_number); 
	exit(error_number);
}
void error_kernels(int error_number, char *program) {
	fprintf(stderr, "%s> Error: Input and output kernels not compatible [e.c. %d]\n", program, error_number); 
	exit(error_number);
}
void error_kernel_size(int error_number, char *program, unsigned kernal_size) {
