		...
		// -->
										...
										<table width="748">
											<td width="461"></c:if>
												...
												<table>
													<tr>
														<td width="179" class="text4"><p>&nbsp;</p>
															<p>Step 3 (Download 3DZD)</p></td>
													</tr>
												</table>

												<p>Do you want to download 3dzd file of your query? </p>
												<input type="button" onclick="submitForm('cgi-bin/batch_zdn_lookup.php')" value="Get 3D Zernike Descriptor" />

												<table>
													<tr>
														<td class="text4"><p>&nbsp;</p>
															<p>Step 4 (Filter)</p></td>
													</tr>
												</table>
												<table width="650" border="1">
													<tr>
												...
												<table width="650">
													...
													<tr>
														<td align="center"><input type="button" onclick="submitForm('cgi-bin/searchbatch.php')" value="Submit" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input
