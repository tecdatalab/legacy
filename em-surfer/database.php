...
function db_connect($server = 'localhost', $username = 'kihara', $password = 'dragon', $database = 'davidla', $link = 'db_link') {
	global $$link;
...
function db_query($query, $link = 'db_link') {
	...
	$result = mysqli_query($query, $$link) or db_error($query, mysqli_errno(), mysqli_error());
