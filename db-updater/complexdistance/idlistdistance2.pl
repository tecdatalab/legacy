...
# Script: perl idlistdistance2.pl 5001 10000 singlechaincomplexidlist2
...
$singlechaincomplexidlistfile=$ARGV[2];
...
foreach my $m ($ARGV[0] .. $ARGV[1]) {
	...
	if ( $lenhash < 2 ) {
		...
		print OUTSINGLE $pdbid . "\n";
	} else {
		
		 open( OUT, ">distance/$pdbid" );
